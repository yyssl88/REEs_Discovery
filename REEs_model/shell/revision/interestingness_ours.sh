...
train_file=${dirpath}'/REEs_model_data/revision/labeled_data_400/'${task[${tid}]}'/train_'${cid}'/train.csv'
...
interestingness_model_path=${dirpath}"/REEs_model_data/revision/labeled_data_400/"${task[${tid}]}"/train_"${cid}"/model/"
vobs_file=${dirpath}'/REEs_model_data/revision/labeled_data_400/'${task[${tid}]}'/train/tokenVobs.txt'
mkdir ${interestingness_model_path}
interestingness_model_txt_path=${dirpath}'/REEs_model_data/revision/labeled_data_400/'${task[${tid}]}'/train_'${cid}'/model.txt'
