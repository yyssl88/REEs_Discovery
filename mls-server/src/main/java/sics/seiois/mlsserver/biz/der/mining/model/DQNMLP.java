...
public class DQNMLP {
    ...
    public void DQNMLP(int feature_num, int action_num, List<double[][]> hiddenMatrices) {
    ...
    public void DQNMLP(int feature_num, int action_num, String model_path) {
        this.feature_num = feature_num;
        this.action_num = action_num;
        this.matrices = new ArrayList<>();
        FileReader fr = null;
    ...
    public double[][] run(double[][] features) {
        ...
        temp = temp.mult(this.matrices.get(this.matrices.size() - 1));
