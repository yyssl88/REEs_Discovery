...
public class ParallelRuleDiscoverySamplingConstant {
    // predicate set
...
//            this.index2predicates.put(k, p);
    ...
    public ParallelRuleDiscoverySamplingConstant() {
    }

    public ParallelRuleDiscoverySamplingConstant(List<Predicate> predicates, int K, int maxTupleNum, long support,
...
//            }
            ...
            MultiTuplesRuleMiningOptConstant multiTuplesRuleMiningOptConstant = new MultiTuplesRuleMiningOptConstant(bobj.getMax_num_tuples(),
            ...
            List<Message> messages = multiTuplesRuleMiningOptConstant.validationMap1(unitSet, pBegin);
...
//            }
    ...
    private static Logger logger = LoggerFactory.getLogger(ParallelRuleDiscoverySamplingConstant.class);
